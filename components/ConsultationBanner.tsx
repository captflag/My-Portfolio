      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center lg:items-end gap-4 md:gap-6 w-full lg:w-auto">
             ...
             <button 
               onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
               className="group w-full lg:w-[400px] py-4 md:py-6 border border-white/10 hover:border-cyber-blue bg-white/5 rounded-xl md:rounded-2xl flex items-center justify-center gap-4 transition-all hover:bg-white/10"
             >
